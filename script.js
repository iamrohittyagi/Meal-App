        ...
        const mealString = meals.map((meal) => {
            ...
            return `<li class="meal">
                <div class="card" style="width: 18rem; ">
                    <img src="${meal.strMealThumb}"/img class="card-img-top">
                    <div class="card-body meal-name" id="${meal.idMeal}" >
                            <h5 class="recipe-name">${meal.strMeal}</h5>
                            <i class="fa-regular fa-heart  fav-btn ${ isFav ? 'fas' : 'far' }"></i>
                    </div>
                </div>
             </li>`;
